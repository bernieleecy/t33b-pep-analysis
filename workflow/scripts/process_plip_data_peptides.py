...
for frame, file in enumerate(file_list):
    ...
    hydrophobic_interactions = get_interaction(root, "hydrophobic_interactions")
...
hydrophobic_breakdown = df_hydrophobic.groupby(
    ["Peptide_number", "Peptide_ID", "Protein_ID", "Type"], as_index=False
).size()
hydrophilic_breakdown = df_hydrophilic.groupby(
    ["Peptide_number", "Peptide_ID", "Protein_ID", "Type"], as_index=False
).size()
...
hydrophobic = hydrophobic_breakdown[
    hydrophobic_breakdown["Type"] == "hydrophobic_interactions"
]
