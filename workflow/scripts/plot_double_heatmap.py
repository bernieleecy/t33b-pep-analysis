...
df_1 = gen_df(snakemake.input.f1,
                       n_runs=snakemake.params.n_runs)
df_2 = gen_df(snakemake.input.f2,
                       n_runs=snakemake.params.n_runs)
...
sns.heatmap(df_1, vmin=vmin, vmax=vmax,
            cmap='rocket', ax=axes[0], cbar=False)
sns.heatmap(df_2, vmin=vmin, vmax=vmax,
            cmap='rocket', ax=axes[1],
            cbar=False)
